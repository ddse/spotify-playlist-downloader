...
def test_live_zingmp3_search_returns_real_result():
    ...
    # https://ac.zingmp3.vn/v1/web/search?q=Sơn%20Tùng%20M-TP&type=audio&page=1&num=10
    result = zing.search("Sơn Tùng M-TP", page=1, limit=10)
    ...
    item = result["items"][0]
    _assert_real_result(item, "zingmp3.vn", "Sơn Tùng M-TP")

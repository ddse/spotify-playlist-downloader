...
const translations = {
  vi: {
    ...
    'WireGuard':'WireGuard',
    'Schedule':'Lịch',
    'Subscription schedule':'Lịch đồng bộ đăng ký',
    'Controls automatic background synchronization of enabled subscriptions.':'Điều khiển việc đồng bộ nền tự động các đăng ký đang bật.',
    'Run subscription scheduler':'Chạy bộ lập lịch đăng ký',
    'Automatic synchronization is enabled.':'Đồng bộ tự động đang bật.',
    'Automatic synchronization is off. No background subscription sync will run.':'Đồng bộ tự động đang tắt. Sẽ không chạy đồng bộ đăng ký nền.',
    'Subscription scheduling enabled':'Đã bật lịch đồng bộ đăng ký',
    'Subscription scheduling disabled':'Đã tắt lịch đồng bộ đăng ký',

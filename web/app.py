...
@app.post('/api/queue/{track_id:path}/start')
...
@app.post('/api/queue/{track_id:path}/pause')
...
@app.post('/api/queue/prioritize/{track_id:path}')
...
@app.delete('/api/files/{track_id:path}')
...
@app.delete('/api/queue/{track_id:path}')
